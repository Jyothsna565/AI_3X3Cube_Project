...
class State:
    def __init__(self, size=3, c=None):
        ...
        '''nums = ['White','Blue','Red','Orange','Green','Yellow']*(size**2)
        # shuffle numbers
        shuffle(nums)
        ...
        self.__front__ = [['White','White','White'],['White','White','White'],['White','White','White']]
        self.__back__ = [['Yellow','Yellow','Yellow'],['Yellow','Yellow','Yellow'],['Yellow','Yellow','Yellow']]
        self.__top__ = [['Red','Red','Red'],['Red','Red','Red'],['Red','Red','Red']]
        self.__bottom__ = [['Orange','Orange','Orange'],['Orange','Orange','Orange'],['Orange','Orange','Orange']]
        self.__left__ = [['Blue','Blue','Blue'],['Blue','Blue','Blue'],['Blue','Blue','Blue']]
        self.__right__ = [['Green','Green','Green'],['Green','Green','Green'],['Green','Green','Green']]
        self.__sides__ = [self.front(), self.back(), self.left(), self.right(), self.top(), self.bottom()]
